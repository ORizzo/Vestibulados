...
export default function Resposta12(props) {
  ...
  async function core(b) {
    ...
    setls(1);
    if (b === struture["resposta certa12"]) {
      setTimeout(() => props.setI("certo", 12), 1700);
      return "certo";
    } else {
      setTimeout(() => props.setI("errado", 12), 1700);
      return "errado";
    }
  }
