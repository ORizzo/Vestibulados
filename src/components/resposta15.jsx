...
export default function Resposta15(props) {
  ...
  async function core(b) {
    ...
    setls(1);
    if (b === struture["resposta certa15"]) {
      setTimeout(() => props.setI("certo", 15), 1700);
      return "certo";
    } else {
      setTimeout(() => props.setI("errado", 15), 1700);
      return "errado";
    }
  }
