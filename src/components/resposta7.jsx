...
export default function Resposta7(props) {
  ...
  async function core(b) {
    ...
    setls(1);
    if (b === struture["resposta certa7"]) {
      setTimeout(() => props.setI("certo", 7), 1700);
      return "certo";
    } else {
      setTimeout(() => props.setI("errado", 7), 1700);
      return "errado";
    }
  }
