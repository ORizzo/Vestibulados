...
export default function Resposta14(props) {
  ...
  async function core(b) {
    ...
    setls(1);
    if (b === struture["resposta certa14"]) {
      setTimeout(() => props.setI("certo", 14), 1700);
      return "certo";
    } else {
      setTimeout(() => props.setI("errado", 14), 1700);
      return "errado";
    }
  }
