...
export default function Resposta10(props) {
  ...
  async function core(b) {
    ...
    setls(1);
    if (b === struture["resposta certa10"]) {
      setTimeout(() => props.setI("certo", 10), 1700);
      return "certo";
    } else {
      setTimeout(() => props.setI("errado", 10), 1700);
      return "errado";
    }
  }
