...
export default function Resposta8(props) {
  ...
  async function core(b) {
    ...
    setls(1);
    if (b === struture["resposta certa8"]) {
      setTimeout(() => props.setI("certo", 8), 1700);
      return "certo";
    } else {
      setTimeout(() => props.setI("errado", 8), 1700);
      return "errado";
    }
  }
