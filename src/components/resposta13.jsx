...
export default function Resposta13(props) {
  ...
  async function core(b) {
    ...
    setls(1);
    if (b === struture["resposta certa13"]) {
      setTimeout(() => props.setI("certo", 13), 1700);
      return "certo";
    } else {
      setTimeout(() => props.setI("errado", 13), 1700);
      return "errado";
    }
  }
