...
export default function Resposta11(props) {
  ...
  async function core(b) {
    ...
    setls(1);
    if (b === struture["resposta certa11"]) {
      setTimeout(() => props.setI("certo", 11), 1700);
      return "certo";
    } else {
      setTimeout(() => props.setI("errado", 11), 1700);
      return "errado";
    }
  }
