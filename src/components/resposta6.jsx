...
export default function Resposta6(props) {
  ...
  async function core(b) {
    ...
    setls(1);
    if (b === struture["resposta certa6"]) {
      setTimeout(() => props.setI("certo", 6), 1700);
      return "certo";
    } else {
      setTimeout(() => props.setI("errado", 6), 1700);
      return "errado";
    }
  }
