...
export default function Resposta4(props) {
  ...
  async function core(b) {
    ...
    setls(1);
    if (b === struture["resposta certa4"]) {
      setTimeout(() => props.setI("certo", 4), 1700);
      return "certo";
    } else {
      setTimeout(() => props.setI("errado", 4), 1700);
      return "errado";
    }
  }
